...
function showTypes<s = void, t = void, m = void>(valueOne: s | string = "Nothing", valueTwo: t | string = "Nothing", valueThree: m | string = "Nothing") {
...
class Game1<tp> {
    constructor(public title: tp, public price: number) { }
    getDiscount<tp>(val: tp) {
