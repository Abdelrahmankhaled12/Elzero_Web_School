...
class Player {
    ...
    details() {
        return `${this.vip ? "VIP " + this.username : this.username}, Type Is ${this.type} Level Is ${this.level}`
    }
}
...
class Player22 implements Play {
...
let player = new Player22(100, "Elzero", 95);
